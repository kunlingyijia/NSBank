...
//			alert(obj.bankcard_id)
			...
			if(obj.cardStatus!=8) //都属于没有卡状态
			{
				...
				{
					$("#cardTips").html("您提交的身份证信息有误,点击<br/>我要办卡重新提交")
				}
...
function shareShow(){
	...
	//android 因为hbuilder 离线打包微信分享的bug，需要自己写原生微信分享
//	if(mui.os.android)
//	{
//			main = plus.android.runtimeMainActivity();
//			var OnekeyShare = plus.android.importClass('cn.sharesdk.onekeyshare.OnekeyShare');
//			var oks = new OnekeyShare();
//			 oks.disableSSOWhenAuthorize(); 
//		    // 分享时Notification的图标和文字  2.5.9以后的版本不     调用此方法
//		     //oks.setNotification(R.drawable.ic_launcher, getString(R.string.app_name));
//		     // title标题，印象笔记、邮箱、信息、微信、人人网和QQ空间使用
//		     oks.setTitle(utils.share_title);
//		     // titleUrl是标题的网络链接，仅在人人网和QQ空间使用
//		     oks.setTitleUrl(utils.share_url+localStorage.getItem(utils.invite_code));
//		     // text是分享文本，所有平台都需要这个字段
//		     oks.setText(utils.share_content);
//		     // url仅在微信（包括好友和朋友圈）中使用
//		     oks.setImageUrl(utils.share_thumbs[0]);
//		     oks.setUrl(utils.share_url+localStorage.getItem(utils.invite_code));
//		     // comment是我对这条分享的评论，仅在人人网和QQ空间使用
//		     oks.setComment(utils.share_content);
//		     // site是分享此内容的网站名称，仅在QQ空间使用
//		     oks.setSite(utils.share_title);
//		     // siteUrl是分享此内容的网站地址，仅在QQ空间使用
//		     oks.setSiteUrl(utils.share_url+localStorage.getItem(utils.invite_code));
//		    // 启动分享GUI
//		     oks.show(main);
//	}
	//ios
...
//	mui.toast('分享操作：');
	...
	var msg={content:utils.share_content,extra:{scene:sb.x}};
