...
- (void)loadView
{
    ...
    NSString* pWWWPath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"Pandora/apps/HelloH5/www/webapp/nsbank/page"];
    ...
    // 启动该应用
    pAppHandle = [[[PDRCore Instance] appManager] openAppAtLocation:pWWWPath withIndexPath:@"launch.html" withArgs:pArgus withDelegate:nil];
